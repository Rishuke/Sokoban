...
public class Sokoban {
	...
	//public static String PATH = "/users/nfs/Etu0/3802410/Documents/2I002/Sokoban/src/";
	...
	public static void main(String[] args) {
		//Configuration sokoban = loadSokoban(EASY, 10);
	...
	public static ArrayList<Direction> jouer(Configuration config) {
		...
		while (!sokoban.victoire()) {
			...
			sokoUI.show(sokoban);
			sokoUI.drawString("Touches : q,z,d,s,r,escape (gauche,haut,droite,bas,recommencer,sortir)", 0.1, 0.95, 32,
					SokobanUI.BLACK);
		}
		sokoUI.endGame(sokoban);
		sokoUI.dispose();
