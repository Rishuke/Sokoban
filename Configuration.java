...
public class Configuration {
	...
	public Configuration(Configuration configuration) {
		...
		this.caisses = new ArrayList<>(configuration.getCaisses());
		this.joueur = new Joueur(configuration,configuration.getJoueur().getPosition());
		this.niveau = new Niveau(configuration.getNiveau().getX(),configuration.getNiveau().getY());
	}
